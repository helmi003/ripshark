...
if(isset($_POST['mail'])){
    ...
    $sql="SELECT * from admin where password='".$password."'AND mail='".$mail."' limit 1";
    ...
    if(mysqli_num_rows($result)==1){
		...
		echo '<script type="text/javascript">alert("Incorrect informations");window.location ="Forma.php"</script>';
    }
		...
		<div class="card">
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					Don't have an account?<a href="newaccounta.php">Sign Up</a>
				</div>
			</div>
		</div>
	</div>
